...
| `TWILIO_ACCOUNT_SID`   | Twilio account SID for SMS alerts                     | From [Twilio Console](https://console.twilio.com/)                               |
| `TWILIO_AUTH_TOKEN`    | Twilio auth token                                     | From Twilio Console                                                              |
| `TWILIO_FROM_NUMBER`   | Verified Twilio phone number that sends SMS           | `+15005550006` (Twilio trial)                                                    |
| `TWILIO_ADMIN_NUMBERS` | Comma-separated list of admin phone numbers to notify | `+911234567890,+911234567891`                                                    |
